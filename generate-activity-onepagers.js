...
const EDIT = {
  p1_course_overview: {
    ...
    <div class="pl font-heading">My 60 hours &mdash; realistically, what days and times will I work? <span class="hint">You need 60 by the end of the semester.</span></div>${ruled(2)}
    <div class="pl font-heading">The weekly deadline rule, in my own words <span class="hint">&mdash; your timesheet and reflection are due every <strong>Sunday by 11:59 PM.</strong> What happens if they aren't in?</span></div>${ruled(2)}
    <div class="tip"><strong>Why we make you write that second one down:</strong> so nobody can say in October that they didn't know. If it isn't submitted, you don't go to your placement that week until it is &mdash; you stay here and finish it. That's not a school rule we invented; it's how getting paid works.</div>`,
  },
